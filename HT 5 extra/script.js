...
const numsArr = transformInputToNums(userInput);
const userNumbers = numsArr.filter(checkUserNumbers);
...
function transformInputToNums (input) {
    ...
    let numbers = inputArr.map(function(item) {
